  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      ...
      if (result.ok) {
        ...
        setErrorMsg(result.ok === false ? result.error : "Error desconocido");
        setStatus("error");
      }
    });
  };
          ...
          {status === "success" ? (
            <div className="terminal-success">
              ...
              <div className="term-body">
                ...
                <div className="line success">
                  &gt; MENSAJE RECIBIDO. TE RESPONDEREMOS PRONTO. GRACIAS, {form.name.toUpperCase() || "JUGADOR"}.<span className="caret">_</span>
                </div>
            ...
            <div className="terminal-error">
              ...
              <div className="term-body">
                ...
                <div style={{ marginTop: 18 }}>
                  <button className="btn ghost" type="button" onClick={retryForm}>
                    REINTENTAR
                  </button>
                </div>
              </div>
